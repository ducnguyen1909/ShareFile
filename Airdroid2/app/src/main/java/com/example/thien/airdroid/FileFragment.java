...
public class FileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ArrayList<File> fileHinh = imageReader(Environment.getExternalStorageDirectory());
        TextView textView = (TextView)FileView.findViewById(R.id.tvSizeImage);
        textView.setText("("+fileHinh.size()+")");
        Log.e("size",fileHinh.size()+"");
